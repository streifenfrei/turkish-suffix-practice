plugins {
    ...
    // No org.jetbrains.kotlin.android: AGP 9 provides built-in Kotlin.
...
android {
    namespace = "com.example.suffixtrainer"
    compileSdk {
        version = release(36) {
            minorApiLevel = 1
        }
    ...
    defaultConfig {
        applicationId = "com.example.suffixtrainer"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Room (prepackaged db via createFromAsset)
